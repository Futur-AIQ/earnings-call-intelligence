...
// Local-dev only: backend has no MySQL/auth configured, so there's no login
// to complete. Set VITE_SKIP_AUTH=true in frontend/.env to skip the login
// screen instead of authenticating. Backend routes are unauthenticated
// either way (see backend/api/deps.py) — this only affects the client gate.
