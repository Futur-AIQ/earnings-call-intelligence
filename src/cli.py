"""Command-line interface for the Earnings Call Intelligence."""
...
app = typer.Typer(
    name="eci",
    help="Earnings Call Intelligence - Analyze earnings call transcripts",
...
def analyze(
    ...
    console.print(
        Panel.fit(
            "[bold blue]Earnings Call Intelligence[/bold blue]\n"
